      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16" dir={isRTL ? 'rtl' : 'ltr'}>
          ...
          <div className="flex items-center space-x-2 rtl:space-x-reverse flex-shrink-0">
            <img src={nawartuLogo} alt="Nawartu" className="h-8 w-8 sm:h-10 sm:w-10" />
          ...
          <div className="flex items-center space-x-2 rtl:space-x-reverse flex-shrink-0">
            ...
            {user ? (
              <DropdownMenu>
                ...
                <DropdownMenuContent align={isRTL ? 'start' : 'end'} className="bg-background border shadow-lg z-50">
                  {profile?.role === 'admin' && (
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="lg:hidden py-4 border-t border-border bg-background/95 backdrop-blur-sm animate-slide-up">

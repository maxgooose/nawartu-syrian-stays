    ...
    backgroundImage: `url(${heroImage})`
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto animate-slide-up">
          ...
          {/* Search Form */}
          <div className="bg-background/95 backdrop-blur-sm rounded-2xl p-4 sm:p-6 md:p-8 shadow-lg max-w-5xl mx-auto border border-border relative animate-fade-in-up mx-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-6 relative z-10" dir={isRTL ? 'rtl' : 'ltr'}>
              {/* Location */}
              <div className="relative">
                ...
                <div className="relative">
                  <MapPin className={`absolute top-3 h-4 w-4 sm:h-5 sm:w-5 text-muted-foreground ${isRTL ? 'right-3' : 'left-3'}`} />
              ...
              <div className="relative">
                ...
                <div className="relative">
                  <Users className={`absolute top-3 h-4 w-4 sm:h-5 sm:w-5 text-muted-foreground ${isRTL ? 'right-3' : 'left-3'}`} />
            ...
            {/* Search Button */}
            <Button onClick={handleSearch} size="lg" className="w-full sm:w-auto px-6 sm:px-12 h-10 sm:h-12 text-base sm:text-lg font-semibold hover-lift relative z-10">

            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 max-w-md mx-auto">
              <div className="flex items-center justify-center gap-2 mb-2">
                ...
                <h3 className="font-semibold text-blue-800 dark:text-blue-200">
                  {language === 'ar' ? 'مكالمة تأكيد مُتوقعة' : 'Confirmation Call Expected'}
                </h3>
              </div>
              <p className="text-sm text-blue-700 dark:text-blue-300">
                {language === 'ar' 
                  ? 'سيتصل بك فريق نورتوا خلال وقت قصير لتأكيد تفاصيل الحجز وترتيب كافة الاحتياجات الخاصة بإقامتك'
                  : 'The Nawartu team will call you very shortly to confirm your booking details and arrange all your stay requirements'
                }
              </p>
            </div>
          </div>
